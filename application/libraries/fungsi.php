...
class fungsi
{
    ...
    public function dateDif($dateStart, $dateEnd, $format)
    {
        $d1 = date_create($dateStart);
        $d2 = date_create($dateEnd);
    ...
    {
        return array (
                    'table_open'          => '<table class="table tablesorter" '.$str_add.' id="'.$id.'">',
