...
//            $this->db->like('kode_jabatan',$search)
...
//                     ->like('nama_jabatan',$search);
    ...
    function get_paged_list($limit = 10, $offset = 0, $search="", $order='kode_jabatan')
    {
        if(!empty($search))
        {
    ...
    // get persons with paging
    function get_paged_list_active($limit = 10, $offset = 0, $search="", $order='kode_jabatan')
    {
        if(!empty($search))
        {
            $this->db->where($search,NULL,false);
//            $this->db->like('kode_jabatan',$search)
//                     ->or_like('nama_jabatan',$search);
        }
