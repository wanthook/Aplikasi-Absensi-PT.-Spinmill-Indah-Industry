...
//                echo form_input(array('type'=>'hidden', 'name'=>'txtId','id'=>'txtId','value'=>$id));
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control input-sm" id="txtPeriode" name="txtPeriode" placeholder="mm-YYYY" style="width:200px">
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="cmbDivisi" class="col-sm-2 control-label">Jenis Laporan <font style="color: red;">*</font></label>
                    <div class="col-sm-10">
                      <input type="text" id="cmbLaporan" name="cmbLaporan" placeholder="Pilih Jenis Laporan" style="width:500px">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <small><em>- Kosongkan karyawan untuk melihat semua karyawan.<br>- Kosongkan Divisi untuk melihat semua divisi.</em></small>
                    </div>
                </div>
                <hr>
                <div class="form-group">
...
//                        echo '&nbsp;&nbsp;';
                        echo form_button(array(
                                    ...
                                    'value' => 'xls',
                                    'class' => 'btn btn-default navbar-btn'
                                ),'<span class="glyphicon '.$button_icon.'"></span>&nbsp;'.$button2);
                        echo '&nbsp;&nbsp;';
                        echo form_button(array(
                                    'type' => 'button',
                                    'class' => 'btn btn-default navbar-btn',
...
<?php 
$this->load->view("page/footer",array('appJs'=>'appLaporanAbsen')); 
?>
