...
//                echo form_input(array('type'=>'hidden', 'name'=>'txtId','id'=>'txtId','value'=>$id));
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="file" class="form-control input-sm" id="txtUploadFile" name="txtUploadFile" style="width:500px">
                    </div>
                </div>   
                <br>
                <br>
                <h3>Format Upload Set Jadwal</h3>
                <img src="<?php echo base_url("images/upload_jenis_jadwal.png")?>">
                <hr>
                <div class="form-group">
